...
all_data = all_data(category_url)
...
liste_tuples = liste_tuples_images(all_data)
print(liste_tuples)


def save_images_to_file(category_url, liste_tuples):
    ...
    for un_tuple in liste_tuples:
        ...
        with filepath.open("wb") as jpgfile:
            jpgfile.write(b"image")


save_images_to_file(category_url, liste_tuples)
